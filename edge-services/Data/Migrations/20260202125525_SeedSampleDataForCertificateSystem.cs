...
{
    /// <inheritdoc />
    public partial class SeedSampleDataForCertificateSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // 5. Insert Crew Certificates with certificate_of_competency = 'National' and country_id = Vietnam
            migrationBuilder.Sql(@"
                DO $$
                DECLARE
                    vnm_id INT;
                ...
                BEGIN
                    ...
                    (
                        'c0000001-0001-0001-0001-000000000001'::uuid, stcw_master_id, 'VNM-MASTER-2024-001',
                        '2024-01-15', '2029-01-15', 'Vietnam Maritime Administration',
                        'National', vnm_id, '/uploads/certificates/master-001.pdf', 'VALID',
                        'Certificate of Competency - Master Mariner Unlimited',
                        false, 'SHIP_01', NOW(), NOW()
                    ),
                    (
                        'c0000001-0001-0001-0001-000000000002'::uuid, stcw_chief_id, 'VNM-CHIEF-2024-002',
                        '2024-02-01', '2029-02-01', 'Vietnam Maritime Administration',
                        'National', vnm_id, '/uploads/certificates/chief-002.pdf', 'VALID',
                        'Certificate of Competency - Chief Officer',
                        false, 'SHIP_01', NOW(), NOW()
                    ),
                    (
                        'c0000001-0001-0001-0001-000000000003'::uuid, medical_id, 'VNM-MED-2024-003',
                        '2024-01-20', '2026-01-20', 'Vietnam Maritime Medical Center',
                        'National', vnm_id, '/uploads/certificates/medical-003.pdf', 'VALID',
                        'Medical Fitness Certificate - Fit for sea duty',
                        false, 'SHIP_01', NOW(), NOW()
                    ),
                    (
                        'c0000001-0001-0001-0001-000000000004'::uuid, basic_safety_id, 'VNM-BST-2024-004',
                        '2024-03-01', '2029-03-01', 'Vietnam Maritime Training Center',
                        'National', vnm_id, '/uploads/certificates/bst-004.pdf', 'VALID',
                        'Basic Safety Training Certificate',
                        false, 'SHIP_01', NOW(), NOW()
                    ),
                    (
                        'c0000001-0001-0001-0001-000000000005'::uuid, gmdss_id, 'VNM-GMDSS-2024-005',
                        '2024-01-25', '2029-01-25', 'Vietnam Maritime Training Center',
                        'National', vnm_id, '/uploads/certificates/gmdss-005.pdf', 'VALID',
