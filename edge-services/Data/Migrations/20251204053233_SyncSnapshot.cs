        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    main_engine_load = table.Column<double>(type: "double precision", nullable: true),
                    ...
                    fuel_oil_consumed_m_e = table.Column<double>(type: "double precision", nullable: true),
                    fuel_oil_consumed_a_e = table.Column<double>(type: "double precision", nullable: true),
                    fuel_oil_consumed_boiler = table.Column<double>(type: "double precision", nullable: true),
                    lube_oil_consumed = table.Column<double>(type: "double precision", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    operation_date_time = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    operation_code = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false),
                    garbage_category = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    description = table.Column<string>(type: "text", nullable: false),
                    quantity = table.Column<double>(type: "double precision", nullable: false),
                    quantity_unit = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    latitude = table.Column<double>(type: "double precision", nullable: true),
                    longitude = table.Column<double>(type: "double precision", nullable: true),
                    port_name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    reception_facility = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ...
                    accidental_discharge_reason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    accidental_discharge_measures = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    officer_in_charge = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    master_signature = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    signed_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    remarks = table.Column<string>(type: "text", nullable: true),
