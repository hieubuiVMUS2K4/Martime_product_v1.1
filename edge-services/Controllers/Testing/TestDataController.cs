        ...
        try
        {
            ...
            var sampleCrew = new List<CrewMember>
            {
                ...
                new CrewMember
                {
                    ...
                    Nationality = "Spain",
                    // PassportNumber = "ES987654321", // Removed - moved to documents table
                ...
                new CrewMember
                {
                    ...
                    Nationality = "China",
                    // PassportNumber = "CN456789123", // Removed - moved to documents table
                ...
                new CrewMember
                {
                    ...
                    Nationality = "Egypt",
                    // PassportNumber = "EG789123456", // Removed - moved to documents table
                ...
                new CrewMember
                {
                    ...
                    Nationality = "India",
                    // PassportNumber = "IN321654987", // Removed - moved to documents table
                ...
                new CrewMember
                {
                    ...
                    // PassportNumber = "PH987456321", // Removed - moved to documents table
                ...
                new CrewMember
                {
                    ...
                    Nationality = "Russia",
                    // PassportNumber = "RU159753486", // Removed - moved to documents table
                ...
                new CrewMember
                {
                    ...
                    Nationality = "Ireland",
                    // PassportNumber = "IE753951456", // Removed - moved to documents table
                ...
                new CrewMember
                {
                    ...
                    // PassportNumber = "KR246813579", // Removed - moved to documents table
