...
-- =====================================================
-- EQUIPMENT ASSETS - Thiết bị tàu biển thực tế
-- =====================================================

-- === ENGINE ROOM - Main Propulsion ===
INSERT INTO equipment_assets (id, asset_code, name, category, manufacturer, model, serial_number, installation_date, current_running_hours, location, criticality, status, default_executor_role, approver_role, technical_specs, notes, is_active, origin_node, created_at, updated_at)
VALUES 
-- Main Engine
...
'Main propulsion engine - 6 cylinder 2-stroke diesel', true, 'SHIP_01', NOW(), NOW()),
...
'Diesel generator set #1 - Primary power', true, 'SHIP_01', NOW(), NOW()),
...
'{"power_kw": 1200, "voltage": 450, "frequency_hz": 60, "cylinders": 6}',
'Diesel generator set #2 - Backup power', true, 'SHIP_01', NOW(), NOW()),
...
'{"power_kw": 1200, "voltage": 450, "frequency_hz": 60, "cylinders": 6}',
'Diesel generator set #3 - Emergency/Backup', true, 'SHIP_01', NOW(), NOW()),
...
'Emergency diesel generator - Auto start on blackout', true, 'SHIP_01', NOW(), NOW()),
...
'HFO transfer pump - Primary', true, 'SHIP_01', NOW(), NOW()),
...
'{"capacity_m3h": 15, "pressure_bar": 4, "type": "screw"}',
'HFO transfer pump - Standby', true, 'SHIP_01', NOW(), NOW()),
...
'Main engine lube oil purifier', true, 'SHIP_01', NOW(), NOW()),
...
'{"capacity_lph": 3100, "type": "centrifugal_separator"}',
'HFO purifier - Primary', true, 'SHIP_01', NOW(), NOW()),
...
'{"capacity_lph": 3100, "type": "centrifugal_separator"}',
'HFO purifier - Standby', true, 'SHIP_01', NOW(), NOW()),
...
'Starting air compressor - Primary', true, 'SHIP_01', NOW(), NOW()),
...
'{"capacity_m3h": 200, "pressure_bar": 30, "stages": 2}',
'Starting air compressor - Standby', true, 'SHIP_01', NOW(), NOW()),
...
'Emergency starting air compressor', true, 'SHIP_01', NOW(), NOW()),
...
'Oil-fired auxiliary boiler for heating', true, 'SHIP_01', NOW(), NOW()),
...
'Waste heat recovery from main engine exhaust', true, 'SHIP_01', NOW(), NOW()),
...
'Anchor windlass - Port side', true, 'SHIP_01', NOW(), NOW()),
...
'{"pull_force_kn": 285, "speed_m_min": 9, "type": "electric_hydraulic"}',
'Anchor windlass - Starboard side', true, 'SHIP_01', NOW(), NOW()),
...
'Forward mooring winch - Port', true, 'SHIP_01', NOW(), NOW()),
...
'{"pull_force_kn": 200, "drum_capacity_m": 220}',
'Forward mooring winch - Starboard', true, 'SHIP_01', NOW(), NOW()),
...
'{"pull_force_kn": 200, "drum_capacity_m": 220}',
'Aft mooring winch - Port', true, 'SHIP_01', NOW(), NOW()),
...
'{"pull_force_kn": 200, "drum_capacity_m": 220}',
'Aft mooring winch - Starboard', true, 'SHIP_01', NOW(), NOW()),
...
'Primary navigation radar - 3cm', true, 'SHIP_01', NOW(), NOW()),
...
'Secondary navigation radar - 10cm', true, 'SHIP_01', NOW(), NOW()),
...
'Primary ECDIS - IMO compliant', true, 'SHIP_01', NOW(), NOW()),
...
'{"display_size": 26, "chart_format": "S-57/S-63", "type_approved": true}',
'Backup ECDIS - IMO compliant', true, 'SHIP_01', NOW(), NOW()),
...
'Master gyro compass', true, 'SHIP_01', NOW(), NOW()),
...
'Class A AIS - SOLAS compliant', true, 'SHIP_01', NOW(), NOW()),
...
'Primary DGPS receiver', true, 'SHIP_01', NOW(), NOW()),
...
'VDR - SOLAS compliant', true, 'SHIP_01', NOW(), NOW()),
...
'Totally enclosed lifeboat - Port side', true, 'SHIP_01', NOW(), NOW()),
...
'{"capacity_persons": 75, "type": "totally_enclosed", "davit_type": "gravity"}',
'Totally enclosed lifeboat - Starboard side', true, 'SHIP_01', NOW(), NOW()),
...
'Fast rescue boat - SOLAS compliant', true, 'SHIP_01', NOW(), NOW()),
...
'CO2 extinguisher - Engine room', true, 'SHIP_01', NOW(), NOW()),
...
'{"capacity_kg": 45, "type": "CO2", "rating": "55B"}',
'CO2 extinguisher - Generator flat', true, 'SHIP_01', NOW(), NOW()),
...
'Foam extinguisher - Accommodation', true, 'SHIP_01', NOW(), NOW()),
...
'DCP extinguisher - Bridge', true, 'SHIP_01', NOW(), NOW()),
...
'Central AC unit for accommodation', true, 'SHIP_01', NOW(), NOW()),
...
'AC unit for bridge and radio room', true, 'SHIP_01', NOW(), NOW()),
...
'Engine room supply fan - Primary', true, 'SHIP_01', NOW(), NOW()),
