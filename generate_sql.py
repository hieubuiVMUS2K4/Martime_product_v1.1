...
sql_statements.append('    SELECT "Id" INTO v_report_type_id FROM "ReportTypes" WHERE "TypeCode" = \'NOON\' LIMIT 1;')
...
for i in range(20):
    ...
    sql_statements.append(f'    INSERT INTO "MaritimeReports" ')
    sql_statements.append(f'    ("Id", "ReportNumber", "ReportTypeId", "ReportDateTime", "Status", "PreparedBy", "ReportData", "Remarks", "IsTransmitted", "IsSynced", "CreatedAt", "OriginNode")')
    ...
    sql_statements.append(f'    INSERT INTO "NoonReports" ')
    sql_statements.append(f'    ("Id", "MaritimeReportId", "ReportDate", "Latitude", "Longitude", "CourseOverGround", "SpeedOverGround", "DistanceTraveled", "DistanceToGo", "WeatherConditions", "SeaState", "WindSpeed", "FuelOilConsumed", "MainEngineRPM", "MainEnginePower", "CrewOnBoard", "CreatedAt")')
    sql_statements.append(f'    VALUES ')
