...
export function NewFormModal(props: NewFormModalProps) {
  const { newFormCode, setNewFormCode, newFormTitle, setNewFormTitle, newFormProcedureId, setNewFormProcedureId, formBuilderData, setFormBuilderData, treeData, addFormField, updateFormField, removeFormField, onClose, onCreate } = props;
  const setShowNewFormModal = (_: boolean) => onClose();
