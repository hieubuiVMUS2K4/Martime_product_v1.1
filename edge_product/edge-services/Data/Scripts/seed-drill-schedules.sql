-- Seed 9 sample drill schedules for 2026 timeline
-- These will appear as bars in the Gantt chart (Ảnh 2)

-- January 2026: Fire drill (OVERDUE - shows RED bar with "-2 w")
...
-- February 2026: Abandon ship drill (COMPLETED - shows GREEN bar with "✓")
INSERT INTO drill_schedules (id, schedule_code, drill_type_id, scheduled_month, scheduled_year, 
    start_date, due_date, overdue_date, status, timeline_label, execution_count, is_auto_generated,
    origin_node, is_synced, created_at, updated_at)
SELECT 
...
-- March 2026: Fire drill (SCHEDULED - shows BLUE bar with "1 m")
INSERT INTO drill_schedules (id, schedule_code, drill_type_id, scheduled_month, scheduled_year, 
    start_date, due_date, overdue_date, status, timeline_label, execution_count, is_auto_generated,
    origin_node, is_synced, created_at, updated_at)
SELECT 
...
-- April 2026: Rescue boat drill (SCHEDULED - shows BLUE bar with "2 m")
INSERT INTO drill_schedules (id, schedule_code, drill_type_id, scheduled_month, scheduled_year, 
    start_date, due_date, overdue_date, status, timeline_label, execution_count, is_auto_generated,
    origin_node, is_synced, created_at, updated_at)
SELECT 
...
-- May 2026: Abandon ship drill (SCHEDULED - shows BLUE bar with "3 m")
INSERT INTO drill_schedules (id, schedule_code, drill_type_id, scheduled_month, scheduled_year, 
    start_date, due_date, overdue_date, status, timeline_label, execution_count, is_auto_generated,
    origin_node, is_synced, created_at, updated_at)
SELECT 
...
-- June 2026: Security drill (SCHEDULED - shows BLUE bar with "4 m")
INSERT INTO drill_schedules (id, schedule_code, drill_type_id, scheduled_month, scheduled_year, 
    start_date, due_date, overdue_date, status, timeline_label, execution_count, is_auto_generated,
    origin_node, is_synced, created_at, updated_at)
SELECT 
...
-- July 2026: Fire drill (SCHEDULED - shows BLUE bar with "5 m")
INSERT INTO drill_schedules (id, schedule_code, drill_type_id, scheduled_month, scheduled_year, 
    start_date, due_date, overdue_date, status, timeline_label, execution_count, is_auto_generated,
    origin_node, is_synced, created_at, updated_at)
SELECT 
...
-- August 2026: Enclosed space drill (SCHEDULED - shows BLUE bar with "6 m")
INSERT INTO drill_schedules (id, schedule_code, drill_type_id, scheduled_month, scheduled_year, 
    start_date, due_date, overdue_date, status, timeline_label, execution_count, is_auto_generated,
    origin_node, is_synced, created_at, updated_at)
SELECT 
    gen_random_uuid(),
    'DS-202608-ENCLOSED-' || substring(gen_random_uuid()::text, 1, 8),
    id,
    8, 2026,
...
-- September 2026: Emergency response exercise (SCHEDULED - shows BLUE bar with "7 m")
INSERT INTO drill_schedules (id, schedule_code, drill_type_id, scheduled_month, scheduled_year, 
    start_date, due_date, overdue_date, status, timeline_label, execution_count, is_auto_generated,
    origin_node, is_synced, created_at, updated_at)
SELECT 
    ...
    NOW(),
    NOW()
FROM drill_types WHERE drill_code = 'EMERGENCY_RESPONSE_QUARTERLY' LIMIT 1;
