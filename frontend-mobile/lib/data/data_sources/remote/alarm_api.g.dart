...
class _AlarmApi implements AlarmApi {
  ...
  Future<List<SafetyAlarm>> getActiveAlarms() async {
    ...
    final _options = _setStreamType<List<SafetyAlarm>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<SafetyAlarm> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => SafetyAlarm.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  Future<AlarmStatistics> getStatistics({int days = 30}) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AlarmStatistics>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late AlarmStatistics _value;
    try {
      _value = AlarmStatistics.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<HttpResponse<void>> generateSampleAlarms() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<void>>(Options(
      ...
      responseType: ResponseType.json,
        ...
        .compose(
          _dio.options,
          '/api/alarms/test/generate-sample',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
