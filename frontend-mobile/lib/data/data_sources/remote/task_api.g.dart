...
class _TaskApi implements TaskApi {
  ...
  Future<List<TaskChecklistItem>> getTaskChecklist(int taskId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<TaskChecklistItem>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<TaskChecklistItem> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              TaskChecklistItem.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<void> completeChecklistItem(
    ...
    final _options = _setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/maintenance/tasks/${taskId}/checklist/${detailId}/complete',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<TaskProgress> getTaskProgress(int taskId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TaskProgress>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          '/api/maintenance/tasks/${taskId}/progress',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TaskProgress _value;
    try {
      _value = TaskProgress.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
